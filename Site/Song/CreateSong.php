...
class CreateSong implements IExecutable, IBuildable, IRoutable, ITestable
{
	...
	function execute(IRequest $Request) {
        ...
        $Form->addContent(new HTMLRelayChat($Request, 'public-chat-songs'), IHTMLContainer::KEY_RENDER_CONTENT_AFTER);
	...
	static function handleBuildStatic(IBuildRequest $Request) {
		...
		$RouteBuilder->writeRoute('ANY ' . self::FORM_ACTION2, __CLASS__, IRequest::NAVIGATION_ROUTE | IRequest::NAVIGATION_LOGIN_ONLY, "Songs");
	}
