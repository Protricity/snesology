...
(function(){
    ...
    var ready = function() {
        ...
        var searchSongTagsPath = 'search/reviewtags/';
        ...
        var doAutoList = function(input, tagName) {
            ...
            var InputValue = jQuery(input); // FieldSet.find('*[name=' + PARAM_REVIEW_TAG_VALUE + ']');
        ...
        jQuery('fieldset')
            .has('*[name=' + PARAM_REVIEW_TAG_NAME + ']')
            .has('*[name=' + PARAM_REVIEW_TAG_VALUE+ ']')
            .each(function(i, fieldset) {
                var InputName = jQuery(fieldset).find('*[name=' + PARAM_REVIEW_TAG_NAME + ']');
                var InputValue = jQuery(fieldset).find('*[name=' + PARAM_REVIEW_TAG_VALUE + ']');
